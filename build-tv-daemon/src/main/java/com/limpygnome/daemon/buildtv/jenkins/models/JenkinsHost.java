package com.limpygnome.daemon.buildtv.jenkins.models;
...
public class JenkinsHost
{
    ...
    public LedPattern update(RestClient restClient)
    {
        try
        {
            ...
            LedPattern ledPatternHighest = LedPattern.BUILD_UNKNOWN;
